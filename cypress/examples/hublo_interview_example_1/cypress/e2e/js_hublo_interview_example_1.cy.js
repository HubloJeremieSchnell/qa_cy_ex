...
// 2. Testing unauthorized page, user should see "You are not logged in and cannot access this page" if he's not logged
...
// 6.a Low level Algorythm: method get_table is returning a table with 50 values between 1 and 10, please calculate the sum of numbers between or equal to 4 and 7
// 6.b Middle level Algprythm: method get_table is returning a table with 50 values between 1 and 10, please determine if there is more 4 than 7
// 6.c High level Algprythm: method get_table is returning a table with 50 values between 1 and 10, please create a method to define which number are present a odd number of times
